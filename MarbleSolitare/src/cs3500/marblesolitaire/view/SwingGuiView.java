...
public class SwingGuiView extends JFrame implements MarbleSolitaireGuiView {
  ...
  /**
   * overrides the rendermessage method
  ...
  /**
   * overrides the accept controller method
   * @param features
   */
  @Override
  public void acceptController(ControllerFeatures features) {
    this.boardPanel.accept(features);
  }
}
