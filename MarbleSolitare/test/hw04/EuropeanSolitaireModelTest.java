...
public class EuropeanSolitaireModelTest {
  ...
  public void setUp() {
    ...
    model4 = new EuropeanSolitaireModel(3, 0, 4);
    model5 = new EuropeanSolitaireModel(6, 8, 8);
    model6 = new EuropeanSolitaireModel(2, 2);
    model7 = new EuropeanSolitaireModel(2,2, 2);
  ...
  public void testInitBoard0Arm(){
    try {
      EuropeanSolitaireModel testModel1 = new EuropeanSolitaireModel(0, 2,2);
  ...
  public void testInitBoardNegArm(){
    try {
      EuropeanSolitaireModel testModel1 = new EuropeanSolitaireModel(-1, 2,2);
  ...
  public void testInitBoardNegRow(){
    try {
      EuropeanSolitaireModel testModel1 = new EuropeanSolitaireModel(2, -1,0);
  ...
  public void testInitBoardNegCol(){
    try {
      EuropeanSolitaireModel testModel1 = new EuropeanSolitaireModel(2, 0,-1);
  ...
  public void testInitBoardCol(){
    try {
      EuropeanSolitaireModel testModel1 = new EuropeanSolitaireModel(2, 0,50);
  ...
  public void testInitBoardRow(){
    try {
      EuropeanSolitaireModel testModel1 = new EuropeanSolitaireModel(2, 50,0);
  ...
  public void testInitBoard(){
    EuropeanSolitaireModel model7 = new EuropeanSolitaireModel(2, 2, 2);
  ...
  public void testGetScore() {
    ...
    assertEquals(36, model4.getScore());
    assertEquals(195, model5.getScore());
  ...
  public void testMove() {
    ...
    model3.move(4, 6, 6, 6);
    assertEquals(127, model3.getScore());
    ...
    model4.move(2, 4, 0, 4);
    assertEquals(35, model4.getScore());
    ...
    model5.move(6, 8, 8, 8);
    assertEquals(194, model5.getScore());
